...
func main() {
	...
	derived_context := m_a_p["contexts_nl_basjes_yauaa_context_1"]
	output := GetDerivedContextMap("contexts_nl_basjes_yauaa_context_1",derived_context)
    

	fmt.Println("Agent Class: "+output["contexts_nl_basjes_yauaa_context_1"]["agentClass"])
